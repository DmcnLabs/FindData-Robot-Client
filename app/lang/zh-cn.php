...
return [
    ...
    'next_page' => '>',
    'pre_page' => '<',
    'robot_estimatedsourcedata_tips' => 'robot estimatedsourcedata tips',
    'robot_subjectallowrepeat' => 'subject allow repeat <i class="fa fa-question-circle" data-rel="tooltip" data-original-title="By default, data link de reprocessing is carried out to avoid repeated storage of the same data collected each time. If a single data source does not need to be duplicated, you can add # source ID and 5-bit random string (such as #123abcde) through the above link to supplement suffix"></i><p></p>',
    'robot_subjecturllinkpre' => 'subject url linkpre <i class="fa fa-question-circle" data-rel="tooltip" data-original-title="The data link supplementary prefix can add string prefix to all URLs after the above parsing. The [entryurl] pass through entry URL is supported. The first # of data link is used as the wildcard [boundstr] used below. It can be used in subsequent field identification rules (including custom script rules), which can be used to realize single page cycle or table type data collection"></i><p>(<a href="javascript:insertAtCursor(\'subjecturllinkpre\',\'[entryurl]\');">[entryurl]</a>)</p>',
